...
오늘의 운세를 생성해주세요. 행운의 패(${luckyTile})와 행운의 역(${luckyYaku})은 참고만 하고, 직접 언급하지 마세요.
...
1. 오늘의 마작 운세 (30-50자):
    ...
    "흐름을 타는 날이에요. 대담한 역 만들기에 도전해보세요."
    "신중함이 승리를 부르는 날이에요. 안전한 플레이를 우선하세요."
...
2. 오늘의 팁 (20-40자):
    ...
    "무리한 울기보다는 안전한 텐파이를 우선하세요."
    "리치 타이밍이 승패를 가를 수 있어요."
